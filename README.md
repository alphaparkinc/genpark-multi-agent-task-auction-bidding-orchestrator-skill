# genpark-multi-agent-task-auction-bidding-orchestrator-skill
...
> **GenPark AI Agent Skill** -- Market-based multi-agent task auction and bidding orchestrator (TaskGen style)
